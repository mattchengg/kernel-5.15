...
extern int exynos_cpupm_fcd_notifier_register(struct notifier_block *nb);
...
static inline int exynos_cpupm_fcd_notifier_register(struct notifier_block *nb) { return 0; }
